...
namespace Litigator.Tests.Services
{
    public class JudgeServiceTests : IDisposable
    {
        ...
        public JudgeServiceTests()
        {
            ...
            {
                cfg.CreateMap<Judge, JudgeDTO>()
                    .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name.Display));
                cfg.CreateMap<Judge, JudgeDetailDTO>()
                ...
                cfg.CreateMap<JudgeDetailDTO, Judge>()
                    .ForMember(dest => dest.Name, opt => opt.MapFrom(src => PersonName.Create(src.FirstName, src.LastName)));
        ...
        public async Task GetJudgeEntityByIdAsync_ExistingId_ReturnsJudgeEntity()
        {
            ...
            result!.JudgeId.Should().Be($"J#{judge.JudgeId}");
