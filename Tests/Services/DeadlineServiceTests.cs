...
public class DeadlineServiceTests : IDisposable
{
    ...
    private void SeedTestData()
    {
        var attorney = new Attorney
        {
            ...
            PrimaryAddress = Address.Create("456 Lawyer Street", null, "Law City", "Manhattan", "NY", "10001"),
        ...
        var client = new Client
        {
            ...
            PrimaryAddress = Address.Create("456 Test Ave", null, "Test City", "NY", "Brooklyn", "12345"),
        ...
        var court = new Court
        {
            ...
            Address = Address.Create("123 Fake Street", null, "Test City", "NY", "Queens", "12345"),
